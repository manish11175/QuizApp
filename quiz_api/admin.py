...
class QuestionAdmin(ImportExportModelAdmin):
	...
	fields = ['quiz','questions', 'option1','option2','option3','option4','correct_option','difficulty']
...
class ExamAdmin(admin.ModelAdmin):
	list_display=['exam','active','section1','section2','section3']
...
@admin.register(models.TotalResponse)
class TotalResponse(admin.ModelAdmin):
	list_display=['user','quiz_1','score1','quiz_2','score2','quiz_3','score3','total']