...
<section id="footer">
		<div className="container my-4">
			<div className="row text-center text-xs-center text-sm-left text-md-left">
				...
				<div className="col-xs-12 col-sm-4 col-md-4 text-white">
					<h5>Address</h5>
					
                     <p>Address:357/4,2nd Floor,<br/>Opp.DLF New Town,<br/>Akshyanagar,Bangluru</p>
                    <p>Email:Aishanitechnology@gmail.com</p>
					<p>Mobile:9304682015</p>
